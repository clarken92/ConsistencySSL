...
from components.semi_supervised.cnn13 import MainClassifier_VD_9310gaurav
from models.semi_supervised.ict import ICT_VD
...
parser.add_argument('--ema_4_log_sigma2', type=str2bool, default=True)
...
parser.add_argument('--cent_u_coeff_max', type=float, default=0.1)
parser.add_argument('--cons_coeff_max', type=float, default=10.0)
parser.add_argument('--weight_kld_coeff_max', type=float, default=0.05)
...
def main(args):
    ...
    if args.model_name == "9310gaurav":
        if args.weight_norm:
            ...
            main_classifier = MainClassifier_VD_9310gaurav(
    ...
    # Main model
    # ------------------------------------- #
    model = ICT_VD(x_shape=x_shape, y_shape=num_classes,
                    ...
                    mask_weights=args.mask_weights, alpha=args.alpha,
                    ema_4_log_sigma2=args.ema_4_log_sigma2,
                    cons_against_mean=args.cons_against_mean,
    ...
    loss_coeff_dict = {
        ...
        'weight_kld': hyper_updater.variables['weight_kld_coeff']
    }
    ...
    fetch_keys_AE_s = ['weight_kld', 'sparseness']
    ...
    fetch_keys_AE = fetch_keys_AE_l + fetch_keys_AE_u + fetch_keys_AE_s + fetch_keys_AE_a
