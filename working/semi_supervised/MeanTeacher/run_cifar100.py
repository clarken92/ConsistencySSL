...
DEFAULT_CONFIG_10000 = {
    ...
    "epochs": 1000,
    "steps": 280000,
    "rampup_len_step": 10000,       # This is a big deal
    "rampdown_len_step": 80000,

    "lr_max": 0.1,                  # This is a big deal
    "lr_momentum": 0.9,
    "weight_decay": 0.0001,         # This is a big deal
    "gauss_noise": True,
...
run_config = {
    ...
    # 1000
    # ------------------------ #
    # "run": "0_MT_L10000_Nesterov",
    # "run": "0a_MT_L10000_Nesterov",
    # "run": "0b_MT_L10000_Nesterov",
    # "num_labeled": 10000,
    # "cent_u_coeff_max": 0.0,
    # ------------------------ #
